...
EXPECTED_DOCS_MAPPING = {
    ...
    "Is there a calibration schedule conflict for any equipment?": ["p-102-maintenance-log.md"],
    "What does OSHA 1910.119 require for process safety management?": ["29-cfr-1910-119.md"],
    "Summarize the maintenance history for equipment (P-101, P-102, V-202, T-301)": [
        "p-101-maintenance-log.md", "p-102-maintenance-log.md", "v-202-maintenance-log.md", "t-301-maintenance-log.md"
    ],
    "Are there any unresolved compliance alerts right now?": ["conflict-mock.md"],
    "What is the function of control loops in engineering diagrams?": ["control-loops.md"],
    "What standard defines the format for displaying equipment information on a P&ID?": ["equipment-title-blocks.md"],
    "Who serviced the equipment T-301 and when is it next due?": ["t-301-maintenance-log.md"],
    "What is the purpose of the Hazard Communication Standard?": ["hazard-communication-standard.md"],
    "What does a Piping and Instrumentation Diagram (P&ID) show?": ["piping-and-instrumentation-diagrams-p-ids.md", "p-id.md"],
    "Why is process procedure P-03 in non-compliance with Safety Regulation SR-12?": ["sr-12.md", "p-03.md"],
    "What is the maintenance status of pump P-101 and who serviced it last?": ["p-101-maintenance-log.md"],
    "Is pump P-102 currently compliant with its calibration schedule?": ["p-102-maintenance-log.md"],
    "Which federal law established the Occupational Safety and Health Administration (OSHA)?": ["occupational-safety-and-health-act-of-1970.md"],
    "What is the primary function of Piping and Instrumentation Diagrams (P&IDs)?": ["piping-and-instrumentation-diagrams-p-ids.md"],
    "What is the difference between PFDs and P&IDs?": ["process-flow-diagrams-pfds.md"],
    "What is the role of logic diagrams in industrial equipment?": ["logic-diagrams.md"],
    "What does a SCADA network diagram show?": ["scada-network-diagrams.md"],
    "Identify the technician who serviced valve V-202 and the last service date.": ["v-202-maintenance-log.md"],
    ...
    "What is the purpose of instrument loop elements in a P&ID?": ["instrument-loop-elements.md"],
    "Describe the format of wiring diagrams.": ["wiring-diagrams.md"],
    "How does the Hazard Communication Standard help employees?": ["hazard-communication-standard.md"],
    "What equipment tags are mentioned in the maintenance logs?": [
        "p-101-maintenance-log.md", "p-102-maintenance-log.md", "v-202-maintenance-log.md", "t-301-maintenance-log.md"
    ],
    "What is the maximum pressure permitted for valve V-202 under safety regulations?": ["sr-12.md"],
    "Summarize the maintenance work completed on vessel T-301.": ["t-301-maintenance-log.md"],
    "Under what process safety standard does pump P-102 operate?": ["p-102-procedure.md"],
    "Are there any recurring valve setpoint contradictions in the procedures?": ["sr-12.md", "p-03.md"]
}
...
def main():
    ...
    print(f"  Hit@5        |     {hit_no_rerank:.4f}     |     {hit_with_rerank:.4f}     |   {hit_with_rerank - hit_no_rerank:+.4f}")
    print(f"  MRR          |     {mrr_no_rerank:.4f}     |     {mrr_with_rerank:.4f}     |   {mrr_with_rerank - mrr_no_rerank:+.4f}")
